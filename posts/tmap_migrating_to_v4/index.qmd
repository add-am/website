...
In comparison to the version 3 code required to produce this map, the new syntax available with tmap version 4 is much more consistent, concise, and also somehow does more. For example, lets look at the arguments in the `tm_polygons()` function again:
