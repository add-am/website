...
Looking at these silly scenario's has hopefully made you ask how you can address the problem/avoid it/model the scenario better. There are plenty of ways to do this;
 ...
 - The most obvious of which is to deploy your model with a string of caveats. E.g. "Model only valid for Hill A and Hill B", "Model should not be used beyond 1000m", etc. etc. However, these caveats don't actually stop anyone from using the model in this way - particularly if they are like D.W from Arthor:
