...
extracted_data_multi_day <- extracted_data_multi_day[drop = TRUE]

#save the object
write_stars(extracted_data_multi_day, "multi_day_data.nc")
...
As a precaution it is always a good idea to read your data back in to the environment to make sure everything works just fine. You'll be glad you did because there is actually a small quirk I have found where a time dimension with more than 1 value gets read back in as an attribute.

```{r}

multi_day_data <- read_stars("multi_day_data.nc")
